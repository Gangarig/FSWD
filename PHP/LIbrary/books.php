...
if (mysqli_num_rows($result) >0){
    while($row = mysqli_fetch_assoc($result)){
        $books .= "
        <div class='card m-3 w-100 bg-secondary text-light' style='max-width: 800px;'>
        ...
        <div class='col-md-8'>
            <div class='card-body h-75 pt-5 m-1'>
                ...
                <p class='fw-bold fs-3'>Author : ".$row['author']."</p>
                ...
                <a href='details.php? id=".$row['id']."'><button class='btn btn-dark m-2'>Details</button></a>
...
<html lang="en">
    ...
    <body>
        ...
        <h1 class="m-5">Welcome to library</h1>  
